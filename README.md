...
```
cd existing_repo
git remote add origin https://gitlab.com/aniketwarhade212/multithreading-library.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/aniketwarhade212/multithreading-library/-/settings/integrations)
...
Tell people where they can go to for help. It can be any combination of an issue tracker, a chat room, an email addr, etc.
